...
def generate_character_images(label_file, fonts_dir, output_dir):
    """Generate Character image files.
    ...
    image_dir = os.path.join(output_dir, 'character-images')
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            file_string = 'character_{}.jpeg'.format(total_count)
...
if __name__ == '__main__':
    ...
    generate_character_images(args.label_file, args.fonts_dir, args.output_dir)
